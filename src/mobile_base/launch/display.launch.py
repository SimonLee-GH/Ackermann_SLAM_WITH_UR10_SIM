...
def generate_launch_description():
    ...
    default_with_bridge = DeclareLaunchArgument(
        'with_bridge', default_value='true',
        description='Enable bridge: true/false'
    )
    ...
    default_model_path = os.path.join(
        pkg_share, "urdf/base/moveo.urdf.xacro"
    )
    ...
    world_path = os.path.join(pkg_share, "world/lab.sdf")
    ...
    relay_tf = Node(
        ...
        parameters=[
            {
                "input_topic": "/tf",
                "output_topic": "ackermann_steering_controller/tf_odometry",
            }
        ],
        output="screen",
    )
